...
export const BookingConfirmationCard = ({ data, onQuickReply }) => {
  const {
    confirmation_code, guest_name, party_size, booking_date,
    booking_time, table_number, table_location, quick_replies = [],
  } = data
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              {quick_replies.map((reply, index) => (
                <button key={index} onClick={() => onQuickReply?.(reply.action)}
