...
class SessionManager:
    ...
    def __init__(self, redis_service: Optional[RedisService] = None):
        ...
        # Note: Session persistence now handled by LangGraph checkpointing (PostgreSQL)
    ...
    async def close_session(self, session_id: str, session_outcome: Optional[str] = None,
        ...
        Note: Session persistence is now handled by LangGraph PostgreSQL checkpointing.
    ...
    # Note: These methods are deprecated. Session persistence is now handled by LangGraph.
    ...
    def _create_session_summary(self, session: UserSession, conversation: Optional[ConversationContext],
        ...
        logger.warning("_create_session_summary is deprecated. Use LangGraph checkpointing instead.")
        return None
    ...
    def _create_conversation_record(self, conversation: ConversationContext,
        ...
        logger.warning("_create_conversation_record is deprecated. Use LangGraph checkpointing instead.")
        return None
    ...
    def _update_user_profile(self, session: UserSession, session_summary):
        ...
        logger.warning("_update_user_profile is deprecated. Use LangGraph checkpointing instead.")
        return None
...
if __name__ == "__main__":
    ...
    def test_session_manager():
        ...
        # Note: NoSQL persistence removed - now handled by LangGraph checkpointing
        print("\nWARNING: NoSQL persistence deprecated - session state managed by LangGraph PostgreSQL checkpointing")
