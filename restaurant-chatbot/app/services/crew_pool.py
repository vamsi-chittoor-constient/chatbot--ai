...
class CrewPool:
    ...
    def _create_pooled_crew(self, crew_index: int = 0):
        ...
        booking_tools = create_dynamic_booking_tools()
...
For table reservations, delegate to the Booking Specialist.""",
            llm=llm,
        ...
        booking_agent = Agent(
            ...
            goal="Help customers with table reservations",
            backstory="You help customers check availability, make reservations, and manage bookings.",
            llm=llm,
            tools=list(booking_tools.values()),
            verbose=True,
            allow_delegation=True,
            respect_context_window=True,
            cache=False,
...
- For reservations: delegate to Booking Specialist
