...
NOTE: Session and conversation state management is handled by LangGraph's
      checkpointer (MemorySaver/PostgresSaver). This service focuses on
      short-lived caching and real-time messaging only.
"""
...
class RedisService:
    ...
    LangGraph handles conversation state via checkpointing.
