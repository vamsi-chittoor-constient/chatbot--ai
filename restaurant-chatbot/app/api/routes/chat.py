...
async def process_message_with_ai(
    ...
    - Single crew with multiple specialized agents
    - Food Ordering Agent: menu, cart, checkout
    - Booking Agent: reservations, availability
    - Hierarchical process with manager for routing
