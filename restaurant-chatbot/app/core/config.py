...
class Settings(BaseSettings):
    ...
    # React/Feature Flags
    REACT_GLOBAL_ENABLED: bool = True
    REACT_MENU_DISCOVERY_ENABLED: bool = True
    REACT_CART_MANAGEMENT_ENABLED: bool = True
    REACT_MENU_BROWSING_ENABLED: bool = True
    REACT_AB_TEST_PERCENTAGE: int = 100
    REACT_MONGODB_LOGGING_ENABLED: bool = True
    REACT_FINETUNING_DATA_ENABLED: bool = True
    REACT_PERFORMANCE_TRACKING_ENABLED: bool = True
    
    # CrewAI Agent (Simplified single-agent approach)
